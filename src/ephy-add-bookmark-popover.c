...
ephy_add_bookmark_popover_constructed (GObject *object)
{
  ...
  location_entry = ephy_header_bar_get_location_entry (self->header_bar);
                             ...
                             EphyHeaderBar        *header_bar)
{
  ...
  window = ephy_header_bar_get_window (header_bar);
  location_entry = ephy_header_bar_get_location_entry (header_bar);
